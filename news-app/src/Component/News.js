...
export class News extends Component {
    ...
    async componentDidMount() {
        console.log("cdm");
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=89ef9d2b48eb40ec84101ddb3e4804d5&page=1&pageSize=${this.props.pageSize}`;
    ...
    handleNextPage = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=89ef9d2b48eb40ec84101ddb3e4804d5&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`;
        let data = await fetch(url);
        let parsedData = await data.json();
        console.log(parsedData);
        this.setState({
